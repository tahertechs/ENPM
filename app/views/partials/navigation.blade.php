        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            @if(!Auth::check())
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Kaynaklar &nbsp&nbsp</a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{URL::route('questions.index')}}">Sorular</a></li>
                    <li><a href="{{URL::route('home')}}">Notlar</a></li>
                  </ul>
                </li>
            ...
            @else
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Questions &nbsp&nbsp</a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="{{URL::route('questions.create')}}">New Question</a></li>
                    <li><a href="{{URL::route('questions.list')}}">My Questions</a></li>
                    <li><a href="{{URL::route('questions.index')}}">All Questions</a></li>
                  </ul>
                </li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="{{URL::route('posts.list')}}">My Posts</a></li>
