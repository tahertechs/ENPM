          ...
          <div class="row">
            <div class="col-xs-12 col-md-4 ">
              <a href="{{URL::route('posts.show',$post->slug)}}">
                <div><h4><p>{{e($post->title)}}</p></h4></div>
                <div style="margin-bottom:10px"><p>{{Str::limit(e($post->description), $limit = 70)}}</p></div>
              </a>
            </div> 
            ...
            <div class="col-xs-3 col-md-4 text-center">
              ...
              <div class="col-sm-6">
                <a href="{{URL::route('posts.edit' , $post->id)}}">- <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                <a href="{{URL::route('posts.delete' , $post->id)}}">- <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
              </div>
